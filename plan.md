...
- [x] Implementare sistema undo/redo modifiche (tramite file .bak ?) è sufficiente poter ripristinare un bakup dell'ultima modifica - bottone "↩ Restore Backup" nel CarEditorDialog; CarFileManager.restore_bak_files() copia tutti i .bak sull'originale e ricarica l'editor
